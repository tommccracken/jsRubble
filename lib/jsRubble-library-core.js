...
class DistanceConstraint extends AbstractConstraint {
  ...
  enforce(constraint_solver_iterations) {
    let adjusted_stiffness, delta, deltad, deltad1, deltad2, direction_unit_vector;
    this.current_distance = this.p2.pos.distance_from(this.p1.pos);
...
class PointConstraint extends AbstractConstraint {
  ...
  enforce(constraint_solver_iterations) {
    let adjusted_stiffness, current_distance, deltad, direction_unit_vector, strain;
...
class AngleConstraint extends AbstractConstraint {
  ...
  enforce(constraint_solver_iterations) {
    ...
    // Todo: Implement angle constraint enforcement collide
...
class PhysicsWorld {
  ...
  */
  ...
  collision_detection_and_response() {
    let adjustment, cr, cx, cy, dist, dist_prev, line, line_to_circle1, line_to_circle2, line_unit, offset, p1x, p1y, p2x, p2y, particle, particle2, particle2_index, particle_index, proj1, proj2, temp_velx, temp_vely, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _results;
    particle_index = 0;
